...
extension BlockchainFlavorExtension on BlockchainFlavor {
...
Map<BlockchainFlavor, String> basePathMap = {
  ...
  BlockchainFlavor.sepolia: 'https://eth-sepolia.g.alchemy.com/v2/'
};
...
Map<BlockchainFlavor, String> assetContractErc721Map = {
  ...
  BlockchainFlavor.sepolia: '0x5ea6868108990F7f38D03b2c6cbe365a851d38F4'
...
Map<BlockchainFlavor, String> chainIdDescription = {
  ...
  BlockchainFlavor.sepolia: 'Ethereum Sepolia',
};
...
Map<BlockchainFlavor, String> multiChainBlockchainMap = {
  ...
  BlockchainFlavor.sepolia: 'ETHEREUM',
};
